        ...
        <div class="d-flex flex-wrap justify-content-center gap-4">
            ...
            <?php $__currentLoopData = $classes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $class): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                <div style="flex: 0 0 150px;">
                    ...
                    <div class="card feature-card h-100 text-center <?php echo e(($class['muted'] ?? false) ? 'border-secondary-subtle' : ''); ?>">

                        <div class="ratio ratio-1x1 bg-light rounded-top overflow-hidden">
                            <img
                                src="<?php echo e(file_exists(public_path('images/classes/' . $class['file'])) ? asset('images/classes/' . $class['file']) : 'https://placehold.co/300x300?text=' . urlencode($class['name'])); ?>"
                                alt="Contoh gambar <?php echo e($class['name']); ?>"
                                class="w-100 h-100"
                                style="object-fit: cover; <?php echo e(($class['muted'] ?? false) ? 'filter: grayscale(60%);' : ''); ?>">
                        </div>
...
<?php /**PATH C:\Users\Rama\OneDrive\Documents\Semester 8\Skripsi\skripsi-buah2\resources\views/partials/classes.blade.php ENDPATH**/ ?>